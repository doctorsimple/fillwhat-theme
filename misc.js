jQuery('document').ready(function() {
    ...
    jQuery('.navbar-nav').find('a').each(function(i) {jQuery(this).css('animation-duration', (i*2+.5) + 's' )});
...
Drupal.settings.abouttext = {
    ...
    'page__ttc_comparator' : 'Drupal module to take a group of texts, that have short chapters or verses, and compare the contents side by side'
};
